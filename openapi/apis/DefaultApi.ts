...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * LTI-NRPS 受講者の取得
     */
    async apiV2LtiMembershipGetRaw(): Promise<runtime.ApiResponse<{ [key: string]: object; }>> {
        const queryParameters: runtime.HTTPQuery = {};

        const headerParameters: runtime.HTTPHeaders = {};

        const response = await this.request({
            path: `/api/v2/ltiMembership`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * LTI-NRPS 受講者の取得
     */
    async apiV2LtiMembershipGet(): Promise<{ [key: string]: object; }> {
        const response = await this.apiV2LtiMembershipGetRaw();
        return await response.value();
    }
