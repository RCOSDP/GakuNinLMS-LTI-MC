 ...
 * 
 * @export
 * @interface InlineResponse20015Sections
 */
...
export function InlineResponse20015SectionsFromJSON(json: any): InlineResponse20015Sections {
    return InlineResponse20015SectionsFromJSONTyped(json, false);
}

export function InlineResponse20015SectionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20015Sections {
...
export function InlineResponse20015SectionsToJSON(value?: InlineResponse20015Sections | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
